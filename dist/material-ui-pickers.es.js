    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          PickerToolbar$1,
          null,
          React.createElement(FormControlLabel, { value: 'calender', control: React.createElement(Radio, null), label: 'Calender days' }),
          React.createElement(FormControlLabel, { value: 'calender', control: React.createElement(Radio, null), label: 'Business days' })
        ),
        this.props.children,
